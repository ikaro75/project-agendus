 ...
 */
package mx.edu.ilce.intranet.backend;
...
import mx.edu.ilce.intranet.reporte.Reporte.TipoReporte;
...
public class Forma extends Consulta {
    ...
    /**
     * Constructor de la forma a partir de <code>mx.edu.ilce.modelo.Consulta</code> y <code>mx.edu.ilce.modelo.Conexión</code>
     * @param c     Instancia de clase <code>mx.edu.ilce.modelo.Consulta</code>
     * @param cx    instancia de clase <code>mx.edu.ilce.modelo.Conexion</code>
        ...
        try {
            ...
            if (cargaDesdeRequest) {
                ...
                if (super.getAccion().equals("delete")) {
                    ...
                    /*if (super.getCampos().get("clave_tipo_presentacion_forma_foranea").getValor() != null) {
                        this.claveTipoPresentacionFormaForanea = Integer.parseInt(super.getCampos().get("clave_tipo_presentacion_forma_foranea").getValor());
                    }*/
                ...
                try {
                    ...
                    if (oDb.getDbType() == Conexion.DbType.MSSQL) {
                        s = new StringBuilder("select f.tabla, f.llave_primaria, f.alias_tab,f.evento_forma,f.evento_grid,f.instrucciones,f.forma,f.muestra_formas_foraneas, f.clave_tipo_presentacion_forma_foranea, f.permite_duplicar_registro,f.permite_insertar_comentarios,f.permite_guardar_como_plantilla,")
                                ...
                                .append("(select top 1 1 from be_permiso_forma where clave_forma=f.clave_forma AND clave_perfil=" + super.getUsuario().getClavePerfil() + " AND clave_permiso=5) as sensitivedata, ")
                                ...
                                .append(" from ")
                                .append(" be_forma f, be_aplicacion a, be_perfil_aplicacion pa ")
                                .append(" where a.clave_aplicacion=f.clave_aplicacion ")
                                .append(" and a.clave_aplicacion=pa.clave_aplicacion ")
                                .append(" and pa.clave_perfil=").append(super.getUsuario().getClavePerfil())
                        ...
                        s = new StringBuilder("select f.tabla, f.llave_primaria, f.alias_tab,f.evento_forma,f.evento_grid,f.instrucciones,f.forma,f.muestra_formas_foraneas, f.clave_tipo_presentacion_forma_foranea,f.permite_duplicar_registro,f.permite_insertar_comentarios,f.permite_guardar_como_plantilla,")
                                ...
                                .append("(select 1 from be_permiso_forma where clave_forma=f.clave_forma AND clave_perfil=" + super.getUsuario().getClavePerfil() + " AND clave_permiso=5 limit 1) as sensitivedata, ")
                        ...
                        s = new StringBuilder("select f.tabla, f.llave_primaria, f.alias_tab,f.evento_forma,f.evento_grid,f.instrucciones,f.forma,f.muestra_formas_foraneas,f.clave_tipo_presentacion_forma_foranea,f.permite_duplicar_registro,f.permite_insertar_comentarios,f.permite_guardar_como_plantilla,")
                                ...
                                .append("(select 1 from be_permiso_forma where clave_forma=f.clave_forma AND clave_perfil=" + super.getUsuario().getClavePerfil() + " AND clave_permiso=5 AND rownum=1) as sensitivedata, ")
                                ...
                                .append(" from ")
                                .append("be_forma f,")
                                .append("be_aplicacion a,")
                                .append("be_perfil_aplicacion pa ")
                                .append(" where a.clave_aplicacion=f.clave_aplicacion ")
                                .append(" and a.clave_aplicacion=pa.clave_aplicacion ")
                                .append(" and pa.clave_perfil=").append(super.getUsuario().getClavePerfil())
                                .append(" and f.clave_forma=").append(claveForma);
     ...
     * @return Verdadero si se cuenta con permisos para borrar, o falso de lo contrario 
     */
     ...
     * @param delete Verdadero para dar permiso de eliminación en esa forma, falso para denegarlo.
     */
     ...
     * @return Verdadero si se cuenta con permisos para insertar, o falso de lo contrario 
     */
     ...
     * @param insert Verdadero para dar permiso de inserción en esa forma, falso para denegarlo.
     */
    ...
    /**
     * Recupera el permiso para visualizar registro para el perfil del usuario actual
     * @return  Verdadero si se cuenta con permisos para visualizar, o falso de lo contrario 
     */
     ...
     * @param select Verdadero para dar permiso de visualización en esa forma, falso para denegarlo.
     */
    ...
    /**
     * Recupera el permiso para visualizar campos marcados como dato sensitivo en el diccionario de datos para el perfil del usuario actual
     * @return Verdadero si se cuenta con permisos para visualizar datos sensibles, o falso de lo contrario 
     */
    ...
    /**
     * Establece el permiso para visualizar datos marcados como sensibles en el diccionario de datos para el perfil del usuario actual
     * @param sensitiveData Verdadero para dar permiso de visualización en esa forma, falso para denegarlo.
     */
    ...
    /**
     * Recupera el permiso para actualizar registros para el perfil del usuario actual
     * @return Verdadero si se cuenta con permisos para actualizar datos sensibles, o falso de lo contrario  
     */
    ...
    /**
     * Establece el permiso para actualizar registros para el perfil del usuario actual
     * @param update Verdadero para dar permiso de actualización en esa forma, falso para denegarlo.
     */
    ...
    /**
     * Recupera el permiso para visualizar reportes relacionados a la forma para el perfil del usuario actual
     * @return Verdadero si se cuenta con permisos para actualizar datos sensibles, o falso de lo contrario 
     */
    ...
    /**
     * Establece el permiso para visualizar reportes relacionados a la forma para el perfil del usuario actual
     * @param report Verdadero si se cuenta con permisos para visualizar reportes relacionados a la forma, o falso de lo contrario 
     */
    ...
    /**
     * Recupera el nombre del campo que conforma la llave primaria de la tabla vinculada con la forma
     * @return Nombre del campo llave primaria de la tabla vinculada con la forma
     */
    ...
    /**
     * Establece el nombre del campo que conforma la llave primaria de la tabla vinculada con la forma
     * @param llavePrimaria Nombre del campo llave primaria de la tabla vinculada con la forma
     */
    ...
    /**
     * Recupera de la base de datos la definición de la forma a partir de la llave primaria y carga los permisos asociados al perfil que invoca el método.
     * En caso de que la clave primaria de la forma sea negativa se asignan datos reservados a los atributos del objeto
     * puesto que así se indica recuperación de datos de tablas de sistema.
     * Las consultas negativas para alimentar el diccionario de datos son establecidas en la tabla be_consulta_forma
     * @param claveForma    Clave de la forma
     * @param clavePerfil   Clave del perfil
     * @param cx            Instancia de clase <code>mx.edu.ilce.modelo.Conexion</code>
     * @throws Fallo        si ocurre un error de base de datos.
     */
   /* public void setClaveForma(Integer claveForma) throws Fallo {
    ...
    /**
     * Recupera descripción de la entidad a la que hace referencia la forma mostrada en la bitácora
     * @return  Descripción de la entidad a la que hace referencia la forma mostrada en la bitácora,
     * de este valor se toman las dos primeras letras para verificar el género de la entidad y aplicar títulos apropiados 
     * en las operaciones de inserción y edición. Las dos primeras letras deberán ser "el" o "la", por ejemplo: "la forma".
     * En este caso por tratarse de un sustantivo femenino se mostrará la etiqueta "Nueva forma" al momento de que 
     * se genere la forma de inserción
     */
    ...
    /**
     * Establece descripción de la entidad a la que hace referencia la forma mostrada en la bitácora
     * @param aliasTab Descripción de la entidad a la que hace referencia la forma mostrada en la bitácora.
     * Al momento de definir este atributo debe de especificarse el artículo "la" o "el" dependiendo del género
     * de la entidad. Esto se verá reflejado en los títulos de las formas así como en la construcción de frases
     * que reporten la bitácora
     */
    ...
    /**
     * Recupera código javascript que se ejecutará al momento en que se muestra la forma. Tal código puede incluir jQuery.
     * Se recomienda escribir únicamente el nombre de la función con el fin de invocarla.
     * La función invocada deberá estar en un archivo .js con el nombre de la aplicación y deberá tener el nombre
     * de la forma así como el sufijo "_init". 
     * @return Código javascript que se ejecutará al momento en que se muestra la forma.
     */
    ...
    /**
     * Establece código javascript que se ejecutará al momento en que se muestra la forma. Tal código puede incluir jQuery.
     * Se recomienda escribir únicamente el nombre de la función con el fin de invocarla.
     * La función invocada deberá estar en un archivo .js con el nombre de la aplicación y deberá tener el nombre
     * de la forma así como el sufijo "_init".
     * @param eventoForma código javascript a ejecutarse al momento en que se muestra la forma en la capa vista.
     */
    ...
    /**
     * Recupera código javascript que se ejecutará al momento en que se muestra el grid. Tal código puede incluir jQuery.
     * Se recomienda escribir únicamente el nombre de la función con el fin de invocarla.
     * La función invocada deberá estar en un archivo .js con el nombre de la aplicación y deberá tener el nombre
     * de la forma así como el sufijo "_grid_init".
     * @return Código javascript que se ejecutará al momento en que se muestra el grid.
     */
     ...
     * La función invocada deberá estar en un archivo .js con el nombre de la aplicación y deberá tener el nombre
     * de la forma así como el sufijo "_grid_init".
     * @param eventoGrid Código javascript que se ejecutará al momento en que se muestra el grid.
     */
     ...
     * @param muestraFormasForeaneas Verdadero para inidcar que se deben mostrar las formas foraneas, falso de otro modo
     */
    ...
    /**
     * Recupera la marca para activar lo necesario para llevar a cabo la duplicación de un registro desde la capa vista
     * Para tal efecto debe hacerse uso del método duplicate de la consulta, o deberá sobreescribirse 
     ...
     * @param permiteDuplicarRegistro Verdadero si se permite la duplicación, falso de otro modo
     */
    ...
    /**
     * Recupera la marca para activar los mecanismos que permiten agregar comentarios asociados a la forma en la capa vista
     * @return Verdadero si se permite la inserción de comentarios en la forma. Los mecanismos de 
     * inserción se dan desde la capa vista.
     */
    ...
    /**
     * Establece la marca para activar los mecanismos que permiten agregar comentarios asociados a la forma en la capa vista 
     * @param permiteInsertarComentario Verdadero si se permite la inserción de comentarios en la forma. Los mecanismos de 
     * inserción se dan desde la capa vista.
     */
    ...
    /**
     * Recupera la marca para activar los mecanismos que permiten a los usuarios guardar un registro como plantilla
    ...
    /**
     * Establece la marca para activar los mecanismos que permiten a los usuarios guardar un registro como plantilla
     * @param permiteGuardarComoPlantilla  Verdadero si se permite la inserción de registro como plantilla.
     */
    ...
    /**
     * Recupera el objeto <code>mx.edu.ilce.modelo.Consulta</code>de la forma
    ...
    /**
     * Establece el objeto <code>mx.edu.ilce.modelo.Consulta</code>de la forma 
    ...
    /**
     * Establece el objeto <code>mx.edu.ilce.modelo.Consulta</code> de la forma a partir de los parámetros del constructor
     ...
     * @param reglasDeReemplazo <code>ArrayList</code> que contiene los parámetros que serán reemplazados al momento de resolver la consulta
     * @param oDb               Objeto <code>mx.edu.ilce.modelo.Conexion</code> que contiene los datos de la conexión a la db
     * @throws Fallo            Si ocurren problemas al ejecutar la consulta en la base de datos
     */
    ...
    /**
     * Establece el objeto <code>mx.edu.ilce.modelo.Consulta</code> de la forma a partir de los parámetros del constructor 
     * y considerando los parámetros de paginación del grid
     * @param accion            Tipo de consulta (SELECT, INSERT, UPDATE, LOG)
     * @param pk                Valor de la llave primaria de la consulta
     * @param w                 Clausula WHERE de la consulta
     * @param reglasDeReemplazo <code>ArrayList</code> que contiene los parámetros que serán reemplazados al momento de resolver la consulta
     ...
     * @param cx            Objeto <code>mx.edu.ilce.modelo.Conexion</code> que contiene los datos de la conexión a la db     
    ...
    public ArrayList<Reporte> getReportes() throws Fallo {
        ...
        Conexion oDb = new Conexion(super.getUsuario().getCx().getServer(),super.getUsuario().getCx().getDb(),super.getUsuario().getCx().getUser(),super.getUsuario().getCx().getPw(), super.getUsuario().getCx().getDbType());
        String s = "SELECT * FROM reporte WHERE clave_forma=".concat(Integer.toString(this.claveForma)).concat(" AND clave_perfil=").concat(super.getUsuario().toString());
            ...
            while (rsReportes.next()) {
                reporte = new Reporte(
                        ...
                        rsReportes.getString("consulta").replace("%clave_empleado", super.getUsuario().getClave().toString())
                                                        .replace("%clave_area", super.getUsuario().getClaveArea().toString())
     ...
     * @param definicionDeGrid Verdadero si es una definición del grid, falso de otra forma
     */
    ...
    public ArrayList<Nota> getNotas(Integer claveRegistro) throws Fallo {
        ...
        try {
            ...
            s = "SELECT be_empleado.nombre + ' ' + be_empleado.apellido_paterno as nombre, be_empleado.foto, be_nota_forma.* "
     ...
     * @param formasForaneas <code>ArrayList</code> de formas asociadas a la forma
     */
    ...
    public ArrayList<Forma> getFormasForaneas() throws Fallo {
        ...
        Conexion oDb = super.getUsuario().getCx();
        String s = "SELECT * FROM be_forma WHERE clave_forma_padre=".concat(Integer.toString(this.claveForma)).concat(" ORDER BY orden_tab");
    ...
    /**
     * Inserta registro de forma en la base de datos considerando los permisos del administrador,
    ...
    public String insert() throws Fallo {
       ...
       this.claveForma = Integer.parseInt(resultado.toString().split("<pk>")[1].substring(0, resultado.toString().split("<pk>")[1].indexOf("</pk>")));
        ...
        if (super.getCampos().get("tabla").getValor() != null) {
            try {
                oDb.execute("INSERT INTO be_consulta_forma (clave_forma, clave_perfil, consulta, tipo_accion) VALUES("
                ...
                oDb.execute("INSERT INTO be_consulta_forma (clave_forma, clave_perfil, consulta, tipo_accion) VALUES("
                        .concat(String.valueOf(this.claveForma))
                        .concat(",1,'select * from ")
                        .concat(String.valueOf(super.getCampos().get("tabla").getValor()))
                        .concat(" where ")
                ...
                if (oDb.getDbType() == mx.edu.ilce.intranet.modelo.Conexion.DbType.MYSQL) {
                    oDb.execute("INSERT INTO be_consulta_forma (clave_forma, clave_perfil, consulta, tipo_accion) VALUES("
                            .concat(String.valueOf(this.claveForma))
                            ...
                            .concat(" concat(e.nombre,'' '',e.apellido_paterno) as nombre,\n")
                            ...
                            .concat(" and ").concat(super.getCampos().get("llave_primaria").getValor()).concat("= ba.clave_registro\n")
                            .concat(" and ba.clave_forma=").concat(String.valueOf(this.claveForma)).concat("\n")
                            .concat(" order by ba.fecha desc limit 1,10")
                            .concat("','log')"));
                }
                
                if (oDb.getDbType() == mx.edu.ilce.intranet.modelo.Conexion.DbType.ORACLE) {
                    oDb.execute("INSERT INTO be_consulta_forma (clave_forma, clave_perfil, consulta, tipo_accion) VALUES("
                            .concat(String.valueOf(this.claveForma))
        ...
        try {
             if (oDb.getDbType() == mx.edu.ilce.intranet.modelo.Conexion.DbType.MYSQL) {
                String s = "INSERT INTO be_campo_forma"
                        .concat("(clave_forma, clave_perfil,campo,alias_campo,obligatorio,clave_tipo_control,evento,clave_forma_foranea,")
                        .concat(" filtro_foraneo,edita_forma_foranea,ayuda,dato_Sensible,activo,tamano,visible)")
                        .concat(" SELECT ").concat(String.valueOf(this.claveForma)).concat(",1,column_name,column_name,0,1,null,null,null,0,null,0,1,")
                 ...
                 oDb.execute(s);}
             else if (oDb.getDbType() == mx.edu.ilce.intranet.modelo.Conexion.DbType.ORACLE) {
                 ResultSet rsTemp= oDb.getRs("SELECT ".concat(String.valueOf(this.claveForma)).concat(" as clave_forma,1 as clave_perfil,lower(column_name) as campo,lower(column_name) as alias_campo,")
                         .concat("0 as obligatorio, 0 as dato_sensible,1 as activo,data_length*4 as tamano, 1 as visible")
                 ...
                 while (rsTemp.next()) {
                    String s = "INSERT INTO be_campo_forma"
                                ...
                                .concat(rsTemp.getString("dato_sensible")).concat(",")
    ...
    public String delete() throws Fallo {
        ...
        resultado.append(super.delete(true));
    ...
    /**
     * Genera registros de formas a partir de una consulta a las tablas de sistema y permitiendo hacer uso de comodines.
     ...
     * @return              Codigo XML indicando las sentencias ejecutadas para inserción de las formas, 
     *                      sus llaves primarias así como cualquier error o advertencia
     * @throws Fallo SQLException Si ocurre algpun error al acceder a la base de datos
     */
    public String importa(Integer aplicacion, String prefijoTabla, Usuario usuario) throws Fallo {
        ...
        try {
            ...
            if (cx.getDbType()== mx.edu.ilce.intranet.modelo.Conexion.DbType.ORACLE) {
            ...
            } else if(cx.getDbType()==mx.edu.ilce.intranet.modelo.Conexion.DbType.MYSQL) {
