            ...
            if (this.claveContacto != null) {
                ...
                if (c.getEmail()!= null) {
                    mail.sendEmail("intranet@ilce.edu.mx", c.getEmail(),
                            this.getUsuario().getNombre().concat(" ").concat(this.getUsuario().getApellidos()).concat(" quiere compartir ").concat(d.getArchivo().replaceAll("/intranet/temp/".concat(this.getUsuario().getClave().toString()).concat("/"), "")).concat(" contigo"),
