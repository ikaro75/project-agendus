...
%><%@ page import="mx.edu.ilce.intranet.utilerias.*"
...
//request.setCharacterEncoding("UTF-8");
    ...
    File folder = new File("C:\\intranet2.0\\".concat(String.valueOf(user.getClave())));
    ...
    try {
        requestWU.setRepositoryPath("C://intranet2.0//".concat(String.valueOf(user.getClave())));
        ...
        for (int i = 0; i < requestFields.size(); i++) {
            ...
            if (fiField.getName() != null && !fiField.getName().equals("")) {
                ...
                try {
                    ...
                    archivo = new File("c:\\intranet2.0\\".concat(String.valueOf(user.getClave())).concat("\\").concat(archivo.getName()));
                    ...
                    requestParameters.put(fiField.getFieldName(),"/intranet/temp/".concat(user.getClave().toString()).concat("/").concat(Utilerias.decodeURIComponent(fileName)));
