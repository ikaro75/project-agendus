        ...
        <div id="tabcontainer" style="display: inline-block; width: 100%; margin-top: -15px;">
            <div id="tabs" >
                ...
                <div style="padding-right: 5px; float: right; padding-top: 3px; position: relative; top: -30px; width:350px">
                    <div style="float:right; top:0px" id="switcher"><a class="menu_link" target="_blank" href="http://siap.ilce.edu.mx/plataforma"><img style="background-color: white; vertical-align: top; width: 17px;" src="/intranet/img/logo_siap.png">  SIAP 2.0</a> <span style="color:#fff">|</span> <a class="menu_link" target="_blank" href="http://correo.ilce.edu.mx"><span style="display: inline-block; background-color: white;" class="ui-icon ui-icon-mail-closed"></span> Correo</a></div>
                </div>
                <div id="tabInicio">
