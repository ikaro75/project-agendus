<%@page contentType="application/json" pageEncoding="UTF-8"%><%@page import="java.sql.Date"%><%@page import="java.sql.Timestamp"%><%@page import="java.util.LinkedHashMap"%><%@page import="java.util.ArrayList"%><%@page import="mx.edu.ilce.intranet.modelo.*"%><%@page import="mx.edu.ilce.intranet.backend.Forma"%><%@page import="java.text.NumberFormat"%><%@page import="java.text.DecimalFormat"%><%@page import="java.text.SimpleDateFormat"%><%
    String error = "";
    int forma = 0;
    String tipoAccion = "";
    String w = "";
