...
%><%@page import="mx.edu.ilce.intranet.backend.Nota"
...
<% if (frmForma.isPermiteInsertarComentario() && tipoAccion.equals("update")) {%><notas_forma><%
    ...
    for (Nota n : notas) {
        ...
        if (n.getFoto() != null) {
            try {
                File archivoOrigen = new File("c:\\intranet2.0\\".concat(String.valueOf(n.getClaveEmpleado())).concat("\\").concat(n.getFoto().substring(n.getFoto().lastIndexOf("/"))));
