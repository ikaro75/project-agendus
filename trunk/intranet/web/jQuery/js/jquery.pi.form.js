        ...
        $.ajax(
                {
                    ...
                    success: function(data) {
                        ...
                        $("#dlgModal_" + formSuffix).dialog({
                            ...
                            open: function(event, ui) {
                                ...
                                $(".webeditor").tinymce({
                                    ...
                                    script_url : '/jQuery/js/tinymce/tinymce.min.js',
                                    language : 'es',        
                                    // General options
                                    plugins : "pagebreak,layer,table,save,link,image,emoticons,insertdatetime,preview,media,searchreplace,print,contextmenu,paste,directionality,fullscreen,noneditable,visualchars,nonbreaking,template, textcolor",
                                    mode: "none",
                                    ...
                                    theme_modern_buttons3 : "tablecontrols,|,hr,removeformat,visualaid,|,sub,sup,|,charmap,emoticons,media,advhr,|,print,|,ltr,rtl,|,fullscreen",
                                    theme_modern_buttons4 : "insertlayer,moveforward,movebackward,absolute,|,styleprops,|,cite,abbr,acronym,del,ins,attribs,|,visualchars,nonbreaking,template,pagebreak",
                                    theme_modern_toolbar_location : "top",
                                    theme_modern_toolbar_align : "left",
                                    theme_modern_statusbar_location : "bottom",
                                    theme_modern_resizing : true
                                }).removeClass("webeditor").addClass("webeditorProcesed");
          
                            },
                            beforeclose: function(event, ui) {     
                                $(this).find("form").find(".webeditorProcesed").each(function() { 
                        ...
                        $("#formTab_" + formSuffix).tabs('paging',  { cycle: true, nextButton: 'sig &gt;', prevButton: '&lt; prev' });
    ...
    $.fn.form.handleForm = function(xml) {
        ...
        oCampos.each(function() {
            ...
            if (nFormaForanea != undefined) {
                ...
                if (sTipoCampo == "text") {
                ...
                else if ((sTipoCampo == "bit" || sTipoCampo == "tinyint")) {
                    sRenglon += '<td class="etiqueta_forma_control1">' +
                    ...
                    sRenglon += ' /></div></td>§';
                } else if ($.fn.form.options.modo != "lookup" && $(this).find('clave_tipo_control').text() == "3" && oCampo[0].childNodes[0].data != "") {
                    ...
                    if (oCampo.find('clave_tipo_control').text() == "3" && $.fn.form.options.modo != "lookup")
                        sRenglon += ' file" type="file" value="';
                    else if (oCampo.find('clave_tipo_control').text() == "2" && $.fn.form.options.modo != "lookup") {
