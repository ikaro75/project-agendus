package mx.edu.ilce.intranet.agenda;
   ...
   /**
    ...
    public Actividad(Consulta c) throws Fallo {
        ...
        try {
            ...
            if (c.getCampos().get("clave_categoria") != null) {
            ...
            if (c.getCampos().get("clave_forma")!=null) {
            ...
            if (c.getCampos().get("clave_registro")!=null) {
 ...
 /**
    ...
    public String update() throws Fallo {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if (hayCambios) {
                    if (contacto.getEmail()!=null ) {
                        ...
                        resultado.append("<warning><![CDATA[El usuario ").append(contacto.getNombre()).append(" ").append(contacto.getApellidos()).append(" no tiene un correo registrado y no fue posible notificársele.").append("]]></warning>");
                    }
                }  else {
            ...
            if (soyInvitado && this.getClaveRegistro()!=null) {
                ...
                if (this.getClaveEmpleadoSolicitante().intValue()!=this.getUsuario().getClave().intValue()) {
                    ...
                    if (rs.next()) {
                        ...
                        if (this.claveEstatus==2) {
                            asunto = super.getUsuario().getNombre().concat(" ").concat(super.getUsuario().getApellidos()).concat(" ha confirmado su asistencia al evento ").concat(this.getActividad());
                            notificacion = "Estimado(a) ".concat(organizador.getNombre()).concat(" ").concat(organizador.getApellidos()).concat(":<br /><br />")
                                            .concat(super.getUsuario().getNombre()).concat(" ").concat(super.getUsuario().getApellidos()).concat(" ha confirmado su asistencia al evento <strong>").concat(this.getActividad()).concat("</strong> previamente agendada; ")
                                            .concat("para verificar la agenda accede a http://siap.ilce.edu.mx/intranet/.<br /><br /> ")
                                            .concat(super.getUsuario().getNombre());  
                        } else if (this.claveEstatus==3) { 
                            asunto = super.getUsuario().getNombre().concat(" ").concat(super.getUsuario().getApellidos()).concat(" ha confirmado que no asistirá al evento ").concat(this.getActividad());
                            notificacion = "Estimado(a) ".concat(organizador.getNombre()).concat(organizador.getApellidos()).concat(":<br /><br />")
                                            .concat(super.getUsuario().getNombre()).concat(" ").concat(super.getUsuario().getApellidos()).concat(" ha confirmado que no asistirá al evento <strong>").concat(this.getActividad()).concat("</strong> previamente agendada; ")
                                            .concat("para verificar la agenda accede a http://siap.ilce.edu.mx/intranet/.<br /><br /> ")
                                            .concat(super.getUsuario().getNombre());                          
                        } 
