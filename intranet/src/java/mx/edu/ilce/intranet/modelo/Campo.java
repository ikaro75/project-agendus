...
/**
 * Clase encargada de contener el diccinario de datos de una consulta
 */
public class Campo {
     ...
     * @param pk
     * @param w 
     * @param oDb               Objeto <code>mx.edu.ilce.modelo.Conexion</code> con datos de la conexión a la base de datos
    ...
    /**
     * Recupera la marca de dato sensible del campo
     * @return Verdadero si el campo está marcado como dato sensible, falso de otro modo.
     */
    ...
    /**
     * Establece la marca de dato sensible del campo
     * @param datoSensible Verdadero si el campo está marcado como dato sensible, falso de otro modo.
     */
     ...
     */
    public Integer getClaveTipoControl() {
     ...
     */
    public void setClaveTipoControl(Integer claveTipoControl) {
