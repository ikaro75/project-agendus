 ...
 */
package mx.edu.ilce.intranet.reporte;

import mx.edu.ilce.intranet.jasper.Parametro;
...
public class Reporte {
    ...
    public void setClaveReporte(int claveReporte, int clavePerfil, Conexion cx) throws Fallo {
        ...
        try {
            ...
            if (rsReporte.next()) {
                ...
                this.formatoDatosNumericos=rsReporte.getString("formato_datos_numericos");
    ...
    /**
     * Recupera formato con el que se presentarán datos numéricos
     * @return Formato con el que se presentarán daos numéricos , por ejemplo "$ #,##0.00"
     */
    public String getFormatoDatosNumericos() {
        return formatoDatosNumericos;
    }

    /**
     * Establece formato con el que se presentarán datos numéricos
     * @param formatoDatosNumericos Formato con el que se presentarán daos numéricos , por ejemplo "$ #,##0.00"
     */
    public void setFormatoDatosNumericos(String formatoDatosNumericos) {
        this.formatoDatosNumericos = formatoDatosNumericos;
    }
