...
<%@page import="mx.edu.ilce.intranet.modelo.Conexion"%>
<%@page import="mx.edu.ilce.intranet.agenda.Actividad"%>
...
try {    
     ...
     cnsActividad = new Consulta(101, "update", claveActividad.toString() , "", u);
