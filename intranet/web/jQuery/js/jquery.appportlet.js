    ...
    $.fn.appportlet = function(opc){
        ...
        return this.each( function(){
            ...
            if ($.fn.appportlet.options.isKardex!=1) {    
                ...
                '</ul>'+
                '<div id="appTab_'+ $.fn.appportlet.options.category + "_" + $.fn.appportlet.options.app + "_" +$.fn.appportlet.options.form +'">' //La primer pestaña corresponde a la forma principal de la aplicación padre                
            }
            ...
            '<div id="entityCaruosel_' + $.fn.appportlet.options.app + '_' + $.fn.appportlet.options.form + '_' + $.fn.appportlet.options.register + '" class="entityCarrousel">'+            
            ...
            $("#cashFlowPortlet_"+$.fn.appportlet.options.app+ "_"+$.fn.appportlet.options.form+ '_' + $.fn.appportlet.options.register+
              ",#incomeOutcomePortlet_"+$.fn.appportlet.options.app+"_"+$.fn.appportlet.options.form+ '_' + $.fn.appportlet.options.register+
              ",#expensesXCategoryPortlet_"+ $.fn.appportlet.options.app + "_" + $.fn.appportlet.options.form+ '_' + $.fn.appportlet.options.register)
            ...
            //Hace falta llamar al widget que llene el portlet de los filtros
